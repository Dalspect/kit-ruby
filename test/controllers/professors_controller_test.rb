...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { klass_id: @professor.klass_id, user_id: @professor.user_id } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { klass_id: @professor.klass_id, user_id: @professor.user_id } }
