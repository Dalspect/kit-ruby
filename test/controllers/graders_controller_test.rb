...
class GradersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grader" do
    assert_difference('Grader.count') do
      post graders_url, params: { grader: { klass_id: @grader.klass_id, user_id: @grader.user_id } }
    end
  ...
  test "should update grader" do
    patch grader_url(@grader), params: { grader: { klass_id: @grader.klass_id, user_id: @grader.user_id } }
