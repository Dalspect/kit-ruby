...
class SubmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create submission" do
    assert_difference('Submission.count') do
      post submissions_url, params: { submission: { assigned_id: @submission.assigned_id, repo_id: @submission.repo_id } }
    end
  ...
  test "should update submission" do
    patch submission_url(@submission), params: { submission: { assigned_id: @submission.assigned_id, repo_id: @submission.repo_id } }
