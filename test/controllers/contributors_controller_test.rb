...
class ContributorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contributor" do
    assert_difference('Contributor.count') do
      post contributors_url, params: { contributor: { submission_id: @contributor.submission_id, user_id: @contributor.user_id } }
    end
  ...
  test "should update contributor" do
    patch contributor_url(@contributor), params: { contributor: { submission_id: @contributor.submission_id, user_id: @contributor.user_id } }
